...
public class DummyDataLoader implements CommandLineRunner {
    ...
    @Autowired
    public DummyDataLoader(AdminProfileRepo adminProfileRepo, DistributorProfileRepo distributorProfileRepo, ExecutiveProfileRepo executiveProfileRepo, UserRepository userRepository, CategoryRepo categoryRepo, ProductRepo productRepo, OutletRepo outletRepo, AppFeaturesRepo appFeaturesRepo, PasswordEncoder encoder) {
    ...
    private void addDummyUserData() {
        ...
        // Save admin, staff, customer profiles and users to the database
